...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->вернутьс€¬√лавноећенюToolStripMenuItem->Size = System::Drawing::Size(221, 22);
			...
			this->выйти»зѕрограммыToolStripMenuItem->Size = System::Drawing::Size(221, 22);
			...
			this->обѕрограммеToolStripMenuItem->Size = System::Drawing::Size(101, 20);
			...
			this->buttonSavePath->Text = L"—охранить путь";
