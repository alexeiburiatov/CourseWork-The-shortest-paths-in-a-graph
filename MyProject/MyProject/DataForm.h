...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ñãåíåğèğîâàòüToolStripMenuItem->Size = System::Drawing::Size(180, 22);
			...
			this->ââåñòèÂğó÷íóşToolStripMenuItem->Size = System::Drawing::Size(180, 22);
			...
			// 
			this->âûâîäÄàííûõToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->âèçóàëèçèğîâàòüToolStripMenuItem });
